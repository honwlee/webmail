...
exports.OpenAm = function(baseSite, realm, cookieName) {
    ...
    this._tokenValidateUrl = "json/sessions/";
    this._authorizeUrl = 'identity/authorize';
    this._logUrl = 'identity/log';
    this._attributesUrl = "json/users/";
    this._loginUiUrl = "XUI/#login/";
    this._logoutUiUrl = "identity/logout";

}

exports.OpenAm.prototype._request = function(url, callback, method, opts) {
    method = method || "GET";
    opts = opts || {};
    ...
    if (opts.token) options.headers.Cookie = this._cookieName + "=" + opts.token;
...
exports.OpenAm.prototype.getAttributes = function(token, uid, callback) {
    this._request(this._getAttributesUrl(token, uid), function(error, data) {
        if (error) {
            callback(error, false);
            return;
        }
...
exports.OpenAm.prototype._getTokenValidUrl = function(token) {
    return this._baseSite + this._tokenValidateUrl + token + "?_action=validate";
}

exports.OpenAm.prototype._getAttributesUrl = function(token, uid) {
    return this._baseSite + this._attributesUrl + uid;
}
